...
/// Find .env file by walking up from the given directory.
fn find_env_file(from: &Path) -> Result<PathBuf, String> {
...
fn read_env_var(env_path: &Path, key: &str) -> Result<String, String> {
